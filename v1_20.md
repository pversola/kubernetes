...
```
sudo -i
echo 'kube-master 192.168.200.10' >> /etc/hosts
echo 'master01 192.168.200.11' >> /etc/hosts
echo 'master02 192.168.200.12' >> /etc/hosts
echo 'master03 192.168.200.13' >> /etc/hosts
echo 'worker01 192.168.200.21' >> /etc/hosts
echo 'worker02 192.168.200.22' >> /etc/hosts
```
